...
# --- Page config ---
st.set_page_config(page_title="BEE  - Aniket’s Study Saga", layout="wide")
...
">
🔌 {st.session_state.get('subject_name', 'BEE')}
</h1>
...
uploaded_files = st.file_uploader(
    "Upload your BEE past paper PDFs (minimum 2):", type=["pdf"], accept_multiple_files=True
)
    ...
    if st.button("Predict Unit-wise Questions"):
        with st.spinner("Analyzing and predicting questions for each unit..."):
            ...
            if unitwise_predictions:
                pdf_file_name = save_unitwise_questions_as_pdf(unitwise_predictions, subject_name="BEE")
