...
# --- Page config ---
st.set_page_config(page_title="MATHS - Aniket’s Study Saga", layout="wide")
...
">
🔌 {st.session_state.get('subject_name', 'MATHS')}
</h1>
...
""")
st.markdown("<h4 style='color:#2980b9; font-weight:bold;'>📌 Math is not about numbers, it’s about understanding patterns. Conquer it one step at a time!</h4>", unsafe_allow_html=True)
    ...
    if st.button("Predict Unit-wise Questions"):
        with st.spinner("Analyzing and predicting questions for each unit..."):
            ...
            if unitwise_predictions:
                pdf_file_name = save_unitwise_questions_as_pdf(unitwise_predictions, subject_name="MATHS")
