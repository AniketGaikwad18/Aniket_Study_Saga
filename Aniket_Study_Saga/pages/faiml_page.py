...
st.markdown("<h4 style='color:#8e44ad; font-weight:bold;'>📌 Machines learn what you train them. Train your mind, and AI will follow!</h4>", unsafe_allow_html=True)
    ...
    if st.button("Predict Unit-wise Questions"):
        with st.spinner("Analyzing and predicting questions for each unit..."):
            ...
            if unitwise_predictions:
                pdf_file_name = save_unitwise_questions_as_pdf(unitwise_predictions, subject_name="FAIML")
